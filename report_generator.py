...
class ReportGenerator:
	...
	def generate_report(self, scan_results: List[Dict], scan_start_time: datetime, scan_type: str = "auto") -> str:
...
"""
	...
	def generate_json_report(self, scan_results: List[Dict], scan_start_time: datetime, scan_type: str = "auto") -> str:
		report_time = datetime.now()
		timestamp = report_time.strftime("%Y%m%d_%H%M%S")
		...
		for finding in scan_results:
			report_data["findings"].append({
				...
				"secret": {
					...
					"confidence": finding.get('confidence', 'unknown'),
					"pattern": finding.get('pattern', '')[:100]
				},
				"context": {
